...
interface FirebaseWorkshopProps {
    title: string;
    subtitle: string;
    date: string;
    time: string;
...
const FirebaseWorkshop: React.FC<FirebaseWorkshopProps> = ({
    title,
    subtitle,
    date,
    time,
            ...
            <div className="container mx-auto my-20 flex gap-20 flex-col items-center lg:flex-row px-10 md:px-20 lg:px-8 text-center lg:text-left max-w-6xl">
                ...
                <div className="mb-12 lg:mb-0 ">
                    <Image
                        ...
                        width={500}
                        height={300}
                        className="rounded-xl shadow-xl shadow-orange-400"
                    />
                </div>
            </div>
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className={"w-4/5 h-4/5 overflow-scroll border rounded-md"}>
                                            <DialogHeader className={"space-y-5 mt-4"}>
                                                ...
                                                <p className={"text-center"}>IVrijraj is a dedicated CTO and a passionate advocate for community engagement. He actively contributes to the TechFerment community and holds the esteemed title of Google Developers Expert for Firebase and ML. With a wealth of experience, he has conducted over 450+ talks and workshops, sharing his knowledge with various communities. Vrijraj's expertise lies in Web development, Firebase, Google Cloud Platform, and UI/UX Design. He possesses a strong drive for learning new technologies and leveraging them to build innovative solutions. Alongside his professional endeavors, Vrijraj takes pleasure in mentoring individuals and nurturing communities. During his leisure time, he indulges in his love for food and enjoys watching YouTube videos.</p>
...
export default FirebaseWorkshop;
