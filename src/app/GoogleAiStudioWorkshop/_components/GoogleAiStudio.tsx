...
const GoogleAiStudio: React.FC<GoogleAiStudioProps> = ({
    title,
    subtitle,
    date,
    time,
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className={"w-4/5 h-4/5 overflow-scroll border rounded-md"}>
                                            <DialogHeader className={"space-y-5 mt-4"}>
                                                ...
                                                <p className={"text-center"}>Vaibhav is Technical Lead with 8+ years of expertise working with Cloud Technologies. He is also a Google developer expert in GCP. He like to write blogs on medium and share his knowledge in such events.</p>
